...
try:
    ...
    app.logger.info("ANN Model Summary:")
    ann_model.summary(print_fn=app.logger.info)
    ...
    app.logger.info("RNN Model Summary:")
    rnn_model.summary(print_fn=app.logger.info)
